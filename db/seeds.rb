...
Role.create(name: 'Enforcer',
            ...
            passive_text: '',
            text_success: "R.I.P. #{victim.name} (#{victim.role.name}) lies dead on the street.",
...
Role.create(name: 'Chief',
            ...
            text_success: '#{victim.name} was caught by the police and put to jail.',
...
Role.create(name: 'Junior',
            ...
            text_success: "Rats! #{victim.name} (#{victim.role.name}) has been deadly poisoned by the anarchist.",
