class UserChannel < ApplicationCable::Channel
  def subscribed
    ...
    UserChannel.broadcast_to(current_user, type: 'game_updated', data: current_user.game.get_game_object) unless current_user.game.nil?
  end
  ...
  def leave_game (params)
    ...
    GamesChannel.broadcast_to(game, type: 'game_updated', data: game.get_game_object)
